...
const slides = [
  {
    id: 1,
    img: "/images/fastandfurious.jpg",
    title: "FAST & FURIOUS 10",
    releaseDate: "21 JULY 2024",
  },
  {
    id: 2,
          ...
          <SwiperSlide key={slide.id}>
            <div className="relative w-full h-[500px] md:h-[600px] flex justify-center items-center overflow-hidden">
              ...
              <div className="absolute bottom-10 left-1/2 -translate-x-1/2 text-center text-white">
                ...
                <button className="flex items-center gap-3 px-6 py-3 bg-red-600 hover:bg-red-700 transition rounded-full font-semibold text-lg shadow-lg mx-auto">
